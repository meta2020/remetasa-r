## Simulate meta-analysis of proportions according to the BN-GLMM
## N are sampled from lognormal distributions


gen.data2.s = function(
    s, 
    n.med,
    theta,tau,rho,
    y_min,y_max,
  ...
  n = round(rlnorm(s,log(n.med),1))%>% round() # total #subjects
  n = ifelse(n<20,20,n)
