...
py= scale_y_continuous(limits = c(-7,-3), name = "Log odds", n.breaks = 10)
py2= scale_y_continuous(limits = c(-7,-3), name = "Log odds", n.breaks = 10)
...
postscript("plot3.eps", width = 12, height = 14)
