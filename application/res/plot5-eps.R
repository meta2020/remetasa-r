...
load("app5-prop.RData")
load("app5-t-prop.RData")

data = read.csv("../niel-weise21.csv")
yvi1 = escalc(measure="PLO", xi=y0, ni=n0, data=data, to="only0")
yi1 = yvi1[,1]
vi1 = yvi1[,2]

yvi2 = escalc(measure="PLO", xi=y0, ni=n0, data=data, to="all")
yi2 = yvi2[,1]
vi2 = yvi2[,2]
...
py= scale_y_continuous(limits = c(-7,0), name = "Log odds", n.breaks = 10)
py2= scale_y_continuous(limits = c(-7,0), name = "Log odds", n.breaks = 10)
...
postscript("plot5.eps", width = 12, height = 14)
